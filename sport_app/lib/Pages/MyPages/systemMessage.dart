...
class _SystemMessagePageState extends State<SystemMessagePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        backgroundColor: kMainBottomNaviBtnColor,
        body: SafeArea(
                  ...
                  child: Column(
                    ...
                    children: List.generate(
                        ...
                        (index) => BubbleSpecialOne(
                              text:
                                  "【系统消息】：尊敬的用户，我们将在今晚（2024年3月11日）进行系统维护，维护时间预计为北京时间晚上10点至次日凌晨2点。在此期间，我们的服务可能会受到影响，可能会出现一些短暂的中断或延迟。我们感谢您的理解和支持，给您带来的不便，我们深表歉意。感谢您的耐心等待，祝您使用愉快！",
                              isSender: false,
                              tail: true,
                            )),
                  ),
